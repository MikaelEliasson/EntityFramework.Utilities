...
namespace EntityFramework.Utilities
{
    public interface IQueryProvider
    {
		...
		void InsertItems<T>(IEnumerable<T> items, string schema, string tableName, IList<ColumnMapping> properties, DbConnection storeConnection, int? batchSize, SqlBulkCopyOptions? sqlBulkCopyOptions);
