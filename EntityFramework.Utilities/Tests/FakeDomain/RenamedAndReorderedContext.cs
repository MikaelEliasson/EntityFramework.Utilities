...
namespace Tests.FakeDomain
{
    public class RenamedAndReorderedContext : DbContext
    {
        ...
        public static RenamedAndReorderedContext Sql()
        {
            ...
            var ctx = new RenamedAndReorderedContext("Data Source=MACHINEX;Initial Catalog=BatchTests;Integrated Security=SSPI;MultipleActiveResultSets=True;ConnectRetryCount=0");
